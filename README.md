...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tfrvog0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tfrvog0.containers.anotherwebservice.com/
...
```
git clone git@github.com:B3zza/container-tfrvog0.git
cd container-tfrvog0
```
...
```
docker attach container-tfrvog0
```
